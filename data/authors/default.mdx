---
name: Bien (Brian) Pham Xuan
avatar: /static/images/logo.jpg
occupation: Software Engineer
company: Sotatek
email: bienpx224@gmail.com
twitter: https://twitter.com/brian_pham224
linkedin: https://www.linkedin.com/in/brian-it/
github: https://github.com/bienpx224
---

## Hi <Twemoji emoji="waving-hand" /> I'm Brian Pham

I have a passion for all thing **Javascript**.
I enjoy building software and stuff related to build your software product.
I work mainly with **c#**, **Typescript**, **React**, **Node**, **Remix**, and **NextJS**.

<div className="mb-[1em] mt-[2em] flex items-center justify-between [&>h2]:my-0">
  ## Brief timeline of my career
</div>

#### Software Engineer at [Sotatek](https://sotatek.com/)
